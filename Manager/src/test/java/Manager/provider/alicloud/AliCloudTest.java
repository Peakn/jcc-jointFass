...
@SpringBootTest(classes= JointFaasApplicationMain.class)public class AliCloudTest {
    ...
    public void CreateFunctionTest() throws IOException {
        aliCloudProvider.CreateFunction("pythonA", "http://106.15.225.249:8080/pythonA.zip", "python3");
        aliCloudProvider.CreateFunction("pythonB", "http://106.15.225.249:8080/pythonB.zip", "python3");
    }
    ...
    public void ZipFunction() {
        String codeURI = "http://106.15.225.249:8080/index.zip";
        String envCodeURI = "http://106.15.225.249:8080/env.zip";
        String runtime = "python3";
        try {
            File tmpFile = new File("huangemingzi1.zip");
